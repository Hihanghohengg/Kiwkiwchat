...
| **T-11** | **Akses API Tidak Sah Lintas Domain (CORS Bypass)** | AST-13 | ACT-06 | 2 | 3 | **Medium (6)** | `backend/main.py:114-119` (Kebijakan CORS dibatasi ke whitelist domain terdaftar pada `ALLOWED_ORIGINS`). | Static Code Review | `backend/main.py:114-119` | **CODE_REVIEW_ONLY** | **CODE_REVIEW_ONLY**: Inspeksi kode sumber memverifikasi origin whitelist; pengujian dinamis lintas origin dengan penangkapan raw evidence belum diotomasi di test harness. |
...
- **Status PASS / PASS_WITH_FINDINGS**: 12 Ancaman (`T-01`, `T-02`, `T-03`, `T-04`, `T-05`, `T-07`, `T-09`, `T-10`, `T-12`, `T-13`, `T-14`, `T-15`)
- **Status CODE_REVIEW_ONLY**: 1 Ancaman (`T-11` — CORS Whitelist di backend/main.py)
